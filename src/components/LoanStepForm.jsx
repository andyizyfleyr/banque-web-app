...
const LoanStepForm = () => {
    ...
    const loanTypes = [
        ...
        { id: 'creditBuyback', label: t('loans.creditBuyback'), icon: RefreshCw, rate: 0.02, color: 'text-purple-600', bg: 'bg-purple-50' },
        { id: 'studentLoan', label: t('loans.studentLoan'), icon: GraduationCap, rate: 0.02, color: 'text-pink-600', bg: 'bg-pink-50' }
    ];
